...
DATE = "2026년 8월 20일 · v1.0 (M00–M13 · 부록 A/D/E)"
...
저장소의 마크다운 원본을 한 권으로 묶은 것으로, 현재까지 집필이 끝난
**M00부터 M13까지 열네 개 모듈과 부록 세 편**을 담았습니다.
...
Part V(정밀 측정 · DUT 검증 · 보드 설계와 인증)에 해당하는 M14–M17과
캡스톤 과제, 부록 B(공식 치트시트)·C(출처 통합목록)는 집필 예정입니다.
